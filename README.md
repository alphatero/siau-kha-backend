 ...
 **燒角** 是一款專為燒烤店設計的 POS 系統後端專案。該專案使用 [NestJS](https://nestjs.com/) 框架與 [MongoDB](https://www.mongodb.com/) 數據庫進行開發，具有高靈活性與效能，能有效地滿足燒烤店的各種營運需求。
...
| 開發人員 | 負責開發範圍                           |
| -------- | -------------------------------------- |
| 羔羊     | 後端開發，API 開發和數據庫管理  |
| yuyu     | 後端開發，API 開發和數據庫管理   |
| eddie    | 後端開發，API 開發和數據庫管理         |
| alpha    | 前端開發，專注於使用者介面和使用者體驗 |
| 鉛筆     | 前端開發，專注於使用者介面和使用者體驗     |
